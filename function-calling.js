                ...
                "properties": {
                    ...
                    "update_data": {
                        ...
                        "properties": {
                            ...
                            "relationships": {
                                "type": "OBJECT",
                                "description": "他キャラクターとの関係性を管理します。このオブジェクトのキーは、必ず相手のキャラクター名でなければなりません。",
                                "properties": {
                                    "affinity": {
                                        "type": "NUMBER",
                                        "description": "相手への好感度(数値)。この値は上書きされます。数値や上がり幅の基準はユーザーの指定に従います。"
                                    },
                                    "context": {
                                        "type": "STRING",
                                        "description": "相手との思い出や、相手に対する感情・思考の履歴を逐一記録します。新しい出来事があった場合は、既存のテキストに箇条書きで簡潔に追記してください。例:「・市場で偶然出会い、一緒に昼食をとった。彼の横顔を見て心が騒いだ」"
                                    }
                                }
                            },
                            "short_term_goal": {
